...
public class ImageTargetRenderer implements GLSurfaceView.Renderer, AppRendererControl {
    ...
    public ImageTargetRenderer(VuforiaCordovaPlugin imageTarget, VuforiaAppSession session) {
        mVuforiaCordovaPlugin = imageTarget;
    ...
    public void renderFrame(State state, float[] projectionMatrix) {
        ...
        mVuforiaCordovaPlugin.updateDetectedTarget(foundIt, targetName);
    ...
    private void printUserData(Trackable trackable) {
        ...
        Logger.d(LOGTAG, "UserData:Retreived User Data	\"" + userData + "\"");
    }
