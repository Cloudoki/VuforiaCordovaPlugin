...
// Support class based on the Vuforia sample applications
// Responsible for setting up and configuring the OpenGL surface view.
public class AppGLView extends GLSurfaceView {

    private static final String TAG = "Vuforia_GLView";

    // Constructor
    public AppGLView(Context context) {
        super(context);
    }
    ...
    public void init(boolean translucent, int depth, int stencil) {
        ...
        Logger.i(TAG, "Using OpenGL ES 2.0");
        Logger.i(TAG, "Using " + (translucent ? "translucent" : "opaque")
    ...
    private static class ContextFactory implements
        ...
        public EGLContext createContext(EGL10 egl, EGLDisplay display,
            ...
            Logger.i(TAG, "Creating OpenGL ES 2.0 context");
    ...
    private static void checkEglError(String prompt, EGL10 egl)
    {
        ...
        while ((error = egl.eglGetError()) != EGL10.EGL_SUCCESS) {
            Logger.e(TAG, String.format("%s: EGL error: 0x%x", prompt, error));
        }
    }
