...
@property (nonatomic, assign) VuforiaViewController * rootViewController;
...
//------------------------------------------------------------------------------
#pragma mark - Lifecycle
- (id)initWithRootViewController:(VuforiaViewController *) viewController
{
    self = [super init];
    ...
    if (nil != self) {
        ...
        if (audioSessionError != nil) {
            NSLog(@"Audio session init error: %@", [audioSessionError localizedDescription]);
        }
